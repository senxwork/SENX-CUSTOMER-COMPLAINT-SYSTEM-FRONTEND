...
import { TicketCategoryDeleteComponent } from '../ticket-category-delete/ticket-category-delete';
...
export class TicketCategoryListComponent implements OnInit {
  ...
  create(): void {
    this.router.navigate(['/pages/settings/ticket-category/create']);
  }

  edit(id: string): void {
    this.router.navigate(['/pages/settings/ticket-category/edit', id]);
  }

  delete(item: any): void {
    const modalRef = this.modalService.open(TicketCategoryDeleteComponent);
